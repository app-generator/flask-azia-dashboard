# [Flask Dashboard](https://appseed.us/admin-dashboards/flask) Azia

[Admin dashboard](https://appseed.us/admin-dashboards) generated by AppSeed in **[Flask](https://appseed.us/admin-dashboards/flask)** Framework. Azia Dashboard is a beautifully designed admin template featuring a fine selection of useful Bootstrap components and elements. The pre-built pages of the templates are intuitive and very well-designed.
...
---
[Flask Dashboard](https://appseed.us/admin-dashboards/flask) Azia - Provided by **AppSeed [App Generator](https://appseed.us/app-generator)**.
